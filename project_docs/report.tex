...
\caption{Training loss for Stage 1 fine-tuning on Alpaca (52K examples, 3 epochs). Loss decreases from 1.84 to 1.421, demonstrating QLoRA stability on RTX 3080.}
...
(5) \textit{Practical Insights}: Identifies key practical challenges when scaling down large-scale methods, including model capacity requirements, retriever-generator coupling, inference overhead, and synthetic data quality.
